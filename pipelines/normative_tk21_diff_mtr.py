...
class Stats(statistics.SegStats):
    def __init__(self):
        statistics.SegStats.__init__(
            ...
            name="stats",
            segs={
                "kidney_cortex_l": {"dir": "masks_splitlr", "glob": "cortex_l.nii.gz"},
                "kidney_cortex_r": {"dir": "masks_splitlr", "glob": "cortex_r.nii.gz"},
                "kidney_medulla_l": {
                    "dir": "masks_splitlr",
...
MODULES = [
    maps.AdditionalMap(
        ...
        maps={"asl_mtr.nii.gz": "asl_mtr/%s/mtr/reg_mtr_map.nii.gz"},
    ),
    maps.AdditionalMap(
        "diffusion_data",
        srcdir_option="datadir",
