    ...
    def __init__(self):
        statistics.SegStats.__init__(
            ...
            segs={
                ...
                "tkv_r": {"dir": "seg_kidney_t2w", "glob": "*right*.nii.gz"},
            },
            params={
                "t2star_exp": {
                    "dir": "t2star",
                ...
                "b0": {"dir": "b0", "glob": "b0.nii.gz", "segs": ["tkv_l", "tkv_r"]},
                "b1": {"dir": "b1", "glob": "b1.nii.gz", "segs": ["tkv_l", "tkv_r"]},
                "b1_rescaled": {
                    "dir": "b1",
...
MODULES = [
    ...
    maps.T1Molli(
        molli_dir="../fsort/t1",
        molli_glob="t1_raw_molli*.nii.gz",
        tis=[235, 315, 1235, 1315, 2235, 2315, 3235, 4235],
    ),
    maps.B0(),
    maps.B1(),
    maps.MTR(),
    ...
    seg_postprocess.SegFix(
        seg_dir="seg_kidney_t1",
        src_glob="kidney*.nii.gz",
    ...
    statistics.ShapeMetrics(
        ...
        seg_globs=["kidney*left*.nii.gz", "kidney*right*.nii.gz"],
    ),
